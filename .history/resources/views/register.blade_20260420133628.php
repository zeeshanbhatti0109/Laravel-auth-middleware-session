            ...
            <form action="{{ route('register') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" 
                           ...
                           required 
                           autofocus
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition @error('name') border-red-500 @enderror">
                    @error('name')
                ...
                <div class="text-center mt-6">
                    <a href="{{ route('show.login') }}" class="text-indigo-600 hover:text-indigo-800 hover:underline transition">
