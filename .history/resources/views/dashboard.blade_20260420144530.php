    ...
    <div class="min-h-screen flex items-center justify-center px-4">
        <div class="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md transform transition-all">
            <div class="text-center">
                ...
                <a href="{{ route('inner') }}" 
                   class="block w-full bg-green-600 text-white font-semibold py-2 rounded-lg hover:bg-green-700 transition duration-300 transform hover:-translate-y-0.5 shadow-lg mb-3">
                    Go to Inner Page
                </a>

                <!-- Logout Button -->
                <form action="{{ route('inner') }}" method="POST">
                    @csrf
                    <button type="submit" 
